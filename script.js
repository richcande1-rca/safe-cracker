...
const puzzleBank = [
  ...
  },
  {
    ...
    solvePath: [
      "A + C = 8 and A > C, so the outside pairs are 5/3, 6/2, or 7/1.",
      "B = A + 3 turns those into 5-8-3, 6-9-2, or 7-10-1.",
      "Exactly two slots are even; only 6-9-2 has two even values.",
      "B is highest confirms the safe's peak pattern: the center slot sits above both outside slots.",
    ],
    clueKeys: [
      {
        name: "SUM KEY",
        targets: ["A", "C"],
        formula: "A + C = 8",
        text: "The left and right slots add to 8.",
        test: ([slotA, , slotC]) => slotA + slotC === 8,
      },
      {
        name: "ORDER KEY",
        targets: ["A", "C"],
      ...
      },
      {
        ...
        targets: ["A", "B"],
        formula: "B = A + 3",
        text: "The center slot is three clicks higher than the left slot.",
        test: ([slotA, slotB]) => slotB === slotA + 3,
      },
      {
        name: "COUNT KEY",
        targets: ["A", "B", "C"],
  ...
  {
    title: "Expert Safe 002",
    solvePath: [
      "A + C = 8 gives six ordered outside pairs.",
      "B = A + 3 turns the outside pairs into a short list of full-code candidates.",
      "Exactly two slots are even narrows the list to 2-5-6 and 6-9-2.",
      "B is highest confirms the peak pattern and leaves 6-9-2.",
    ],
    clueKeys: [
      {
        name: "SUM KEY",
